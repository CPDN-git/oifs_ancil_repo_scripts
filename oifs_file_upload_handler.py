...
db_config='/storage/boinc/projects/cpdnboinc_alpha/ancil_batch_user_config.xml'
...
def add_file(Vars):
    ...
    if Vars.sub_type=="":
        if Vars.ancil_type=="ic_ancil":
            ...
            url = "http://vorvadoss.oerc.ox.ac.uk/cpdnboinc_alpha/oifs_ancil_files/"+Vars.ancil_type+"/"+expt_path
        else:
            url = "http://vorvadoss.oerc.ox.ac.uk/cpdnboinc_alpha/oifs_ancil_files/"+Vars.ancil_type+"/"+fname
    else:
        url = "http://vorvadoss.oerc.ox.ac.uk/cpdnboinc_alpha/oifs_ancil_files/"+Vars.ancil_type+"/"+Vars.sub_type+"/"+fname
